...
- [ver.h](include/ver.h): project version and build metadata header
- [gen_header.sh](gen_header.sh): generate a single or multiple headers with a custom prefix for . outputs `<proj>_metadata.h` or `<proj>_comp.h`, `<proj>_lang.h`, `<proj>_ver.h`
...
- [versioning.sh](script/versioning.sh): fill `ver.h`
